...
public:
   ...
   */
  static inline IJavascriptWebSocketV2Module &Get() {
    return FModuleManager::LoadModuleChecked<IJavascriptWebSocketV2Module>(
        "JavascriptWebSocketV2");
  }
  ...
  static inline bool IsAvailable() {
    return FModuleManager::Get().IsModuleLoaded("JavascriptWebSocketV2");
  }
};
